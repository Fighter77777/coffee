					<header>
						<!-- filters -->
						<form method="post" action="<?php echo base_url(); ?>project/<?php echo $sel_proj_id ?>/tasks">
							<div class="inputs white">
								<div class="l-lft" style='width: 74%'>
									<div class="row">
										<div class="field">
											<label for="">Название задачи</label>
											<input type="text" name='search_txt' value="<?php echo nl2br($sel_txt) ?>">
										</div>
									</div>
									<div class="row">
										<div class="half">
								...
								<div class="l-rgt" style='width: 24%'>								
									<div class="row">
										<span class="w_check white checked" style='margin-top: 20px; margin-bottom: 32px;'>
						...
						<div class="content-table tasks">
							<table>								
								...
								<tr>
									...
									<td class="comment"><p><?php echo nl2br($tbl['comment']); ?></p></td>
								</tr>							
								<?php }	?>								
							</table>
						</div>
								...
								<div class="field">
									<div class="select">
										...
										<div class="sel_box" sort_rt='<?php echo $numb_rec_url_right; ?>'>
											<a class="pg" href='<?php echo $numb_rec_url_left; ?>10'>10</a>
											<a class="pg" href='<?php echo $numb_rec_url_left; ?>15'>15</a>
											<a class="pg" href='<?php echo $numb_rec_url_left; ?>20'>20</a>
										</div>
										<input type="hidden" name='tsk_in_page'  value="<?php echo $tsk_in_page; ?>">
									</div>
								</div>
