					<header>
						<form method="post" action="<?php echo base_url(); ?>project/<?php echo $project_id ?>/activity">
							<div class="inputs white">
								...
								<div class="row">
									<div class="field user_filter">
										...
										<div class="select">
											<ins></ins><span class="cur"><?php echo (!empty($responsible[$user_id]))?$responsible[$user_id]:"<все>" ?></span>
											<div class="sel_box">
												<a resp_id='0'><все></a>
											...
											<input type="hidden" name='search_responsible'  value="<?php echo $user_id; ?>">
										</div>
									</div>
